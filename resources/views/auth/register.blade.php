            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customRegister') }}">
                        ...
                        <div class="row mb-3">
                            <label for="agency_id" class="col-md-4 col-form-label text-md-end">{{ __('Agency id') }}</label>

                            <div class="col-md-6">
                                <input id="agency_id" type="text" class="form-control @error('agency_id') is-invalid @enderror" name="agency_id" value="{{ old('agency_id') }}" required autocomplete="agency_id" autofocus>
